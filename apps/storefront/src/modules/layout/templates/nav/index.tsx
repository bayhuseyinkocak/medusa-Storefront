...
export default async function Nav() {
  ...
  return (
    <div className="sticky top-0 inset-x-0 z-50 group">
      <header className="relative mx-auto h-16 border-b border-ui-border-base bg-ui-bg-base/80 backdrop-blur-md duration-200">
        <nav className="content-container txt-xsmall-plus text-ui-fg-subtle flex h-full w-full items-center justify-between text-small-regular">
